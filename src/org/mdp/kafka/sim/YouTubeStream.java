...
public class YouTubeStream implements Runnable {
	// cannot be static since not synchronised
	public final SimpleDateFormat YOUTUBE_DATE = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	...
	public YouTubeStream(BufferedReader br, int id, Producer<String, String> producer, String topic, int speedup){
		this(br,id,System.currentTimeMillis(),producer,topic,speedup);
	}
	
	public YouTubeStream(BufferedReader br, int id, long startSim, Producer<String, String> producer, String topic, int speedup){
		this.br = br;
		this.id = id;
	...
	public long getUnixTime(String dateTime) throws ParseException{
		Date d = YOUTUBE_DATE.parse( dateTime );
		return d.getTime();
	}
}
